...
const LoginRegister = React.lazy(() => import("./Pages/LoginRegister/LoginRegister"));
const SubCategory = React.lazy(() => import("./Pages/SubCategory/SubCategory"));
const SingleProductPage = React.lazy(() => import("./Pages/SingleProductPage/SingleProductPage"));
