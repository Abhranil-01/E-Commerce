...
export interface ApiBadmintonBadminton extends Schema.CollectionType {
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    image: Attribute.Media;
    crickets: Attribute.Relation<
      'api::category.category',
      'manyToMany',
      'api::cricket.cricket'
    >;
    runnings: Attribute.Relation<
      'api::category.category',
      'manyToMany',
      'api::running.running'
    >;
    badmintons: Attribute.Relation<
      'api::category.category',
      'manyToMany',
      'api::badminton.badminton'
    >;
    footballs: Attribute.Relation<
      'api::category.category',
      'manyToMany',
...
export interface ApiCricketCricket extends Schema.CollectionType {
...
export interface ApiFootballFootball extends Schema.CollectionType {
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    SizeOne: Attribute.String;
    SizeTwo: Attribute.String;
    SizeThree: Attribute.String;
    SizeFour: Attribute.String;
    SizeFive: Attribute.String;
    badmintons: Attribute.Relation<
      'api::product.product',
      'manyToMany',
      'api::badminton.badminton'
...
export interface ApiRunningRunning extends Schema.CollectionType {
